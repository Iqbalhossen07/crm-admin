...
<motion.div initial="hidden" animate="visible"
    ...
    <motion.header variants={headerVariants}
        ...
        <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
            ...
            <div
                className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 text-purple-600 rounded-xl hidden sm:flex items-center justify-center shadow-sm border border-purple-200 shrink-0">
        ...
        <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-3 sm:gap-5">
            ...
            <button onClick={()=> navigate(-1)}
                ...
                className="w-full sm:w-auto justify-center px-5 py-3 sm:py-2.5 bg-gray-900 hover:bg-black text-white
                text-xs font-bold uppercase tracking-widest rounded-xl shadow-lg transition-all flex items-center gap-2
                active:scale-95"
    ...
    <form id="addJobForm" className="space-y-5 sm:space-y-6 max-w-4xl mx-auto mt-2" onSubmit={handleSubmit}>
        ...
        <motion.div variants={cardVariants}
            ...
            <div
                className="absolute top-0 right-0 w-32 h-32 bg-purple-500/10 rounded-bl-full -mr-6 -mt-6 pointer-events-none group-hover:scale-110 transition-transform duration-700">
            </div>

            <h2
                className="text-lg sm:text-xl font-bold font-merriweather text-gray-900 mb-5 border-b border-gray-200/50 pb-4 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 relative z-10">
                ...
                <div className="md:col-span-2">
                    ...
                    <input type="text" name="task_name" value={formData.task_name} placeholder="e.g. API Integration"
                        required
                ...
                <div>
                    ...
                    <input type="date" name="start_time" value={formData.start_time} required
                        className="w-full px-4 py-3 bg-white/80 border border-gray-200 rounded-xl outline-none focus:border-[#0F8FF0]/50 focus:ring-2 focus:ring-[#0F8FF0]/20 text-sm font-bold text-gray-800 transition-all shadow-sm"
                        onChange={handleChange} />
                ...
                <div>
                    ...
                    <input type="date" name="estimate_finish_time" value={formData.estimate_finish_time} required
                        className="w-full px-4 py-3 bg-white/80 border border-gray-200 rounded-xl outline-none focus:border-[#0F8FF0]/50 focus:ring-2 focus:ring-[#0F8FF0]/20 text-sm font-bold text-gray-800 transition-all shadow-sm"
                        onChange={handleChange} />
        ...
        <motion.div variants={cardVariants} transition={{ delay: 0.1 }}
            ...
            <div
                className="absolute top-0 right-0 w-32 h-32 bg-green-500/10 rounded-bl-full -mr-6 -mt-6 pointer-events-none group-hover:scale-110 transition-transform">
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 relative z-10">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <select name="is_free" value={formData.is_free} onChange={handleChange}
                ...
                <AnimatePresence>
                    ...
                    <>
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
                            exit={{ opacity: 0, scale: 0.8 }} className="budget-fields">

                            <label
                                className="text-[10px] font-bold text-gray-500 mb-2 block uppercase tracking-widest pl-1">

                                Client Charge (£) *

                            </label>

                            <input type="number" step="0.01" name="task_budget" value={formData.task_budget} required
                                placeholder="0.00"
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
                            ...
                            <input type="number" step="0.01" name="paid_budget" value={formData.paid_budget}
                                placeholder="0.00"
        ...
        <motion.div variants={cardVariants} transition={{ delay: 0.2 }}
            ...
            <div
                className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-bl-full -mr-6 -mt-6 pointer-events-none group-hover:scale-110 transition-transform">
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 relative z-10">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <select name="assigned_dev_id" value={formData.assigned_dev_id} onChange={handleChange}
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="dev_budget" value={formData.dev_budget} placeholder="0.00"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="dev_paid" value={formData.dev_paid} placeholder="0.00"
                        className="w-full px-4 py-3 bg-white/80 border border-gray-200 rounded-xl outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 text-base font-black text-gray-800 transition-all shadow-sm"
                        onChange={handleChange} />
        ...
        <motion.div variants={cardVariants} transition={{ delay: 0.3 }}
            ...
            <div
                className="absolute top-0 right-0 w-32 h-32 bg-orange-500/10 rounded-bl-full -mr-6 -mt-6 pointer-events-none group-hover:scale-110 transition-transform">
            </div>
            ...
            <div className="relative z-10">
                ...
                <div
                    className="bg-white/80 border border-gray-200 rounded-xl overflow-hidden shadow-sm focus-within:border-orange-500/50 focus-within:ring-2 focus-within:ring-orange-500/20 transition-all">

                    <CKEditor editor={ClassicEditor} data={formData.description} onChange={handleEditorChange} config={{
        ...
        <motion.div variants={cardVariants} transition={{ delay: 0.4 }} className="pt-2 pb-8 flex justify-end">
...
এইটাকে এখন এডিট পেইজ এ কনভার্ট করে দাও,



এখানে ভাই

একটু কাজ আছে, সেটা হচ্ছে



job_status ড্রপডাউন আকারে থাকবে

In Progress এবং Completed কারন ভাই, জব এর টাকা ক্লিয়ার করতেই পারে, কিন্তু জব এর কাজ ত completed সাথে সাতেহ হবে না, তাই
না ভাই? পরে আইসা করতে পারে যেনো,
এইটা একটা গেলো



আর ভাই, প্রজেক্ট আপডেট এর ক্ষেত্রে যেইটা আপডেট করবে, সেইখান থেকে যেনো আপডেট হই, ধরো জব এর বাজেট আপডেট করলো তাইলে শুধু জব
এর বাজেট আপডেট হই ক্যালকুলেট হবে, কিন্তু ডেভেলপার এর বাজেট কিন্তু চেঞ্জ করে নাই, তাইলে ডেভেলপার এর এর চেঞ্জ হবে না,
ক্লিয়ায়র ভাই?


আবার দেখা যাচ্চেহ জব এর বাজেট ও আপডেট করলো, আবার ডেভেলপার এর বাজেট ও আপডেট করলো তাইলে যেনো সব জায়গায় থেকে আপডেট হই,


সেইম কিন্তু ভাই, payments কালেকশন থেকে চেঞ্জ হই, আবার দেখা যাচ্চেহ শুধু ডেভেলপার এর বাজেট চেঞ্জ হইছে, তাইলে যেনো
...
ভাই, ধরো জব এর বাজেট ২০০০০, ছিলো পেইড করেছে, ৫০০০ তাইলে ডিউ থাকলো ১৫০০০



এখন যদি এডিট এ গিয়ে বাজেট ২০০০০, কিন্তু ৬০০০, তাইলে ডিউ থাকলো ১৪০০০ এইভাবে ক্যালকুলেট হবে না?

তাইলে Total = ২০০০০, Paid =৬০০০ , Due= ১৪০০০

পেমেন্ট এ আগের টা আপডেট হয়ে৬০০০ এটা বসে যাবে,
আবার এখন যদি এডিট এ গিয়ে বাজেট ২৫০০০ বাড়াই দিলো, কিন্তু ৭০০০, তাইলে ডিউ থাকলো ১৮০০০ এইভাবে ক্যালকুলেট হবে না?
তাইলে Total = ২৫০০০ , Paid =৭০০০, Due= ১৮০০০

তাইলে পেমেন্ট পেমেন্ট এ আগের টা আপডেট হয়ে ৭০০০এটা বসে যাবে,



তারপর আসি

সেইম ভাবে ভাই, ডেভেলপার



ভাই, ধরো ডেভেলপার এর বাজেট ২০০০০, ছিলো পেইড করেছে, ৫০০০ তাইলে ডিউ থাকলো ১৫০০০
...
ডেভেলপার পেমেন্ট এ আগের টা আপডেট হয়ে ৬০০০ এটা বসে যাবে,





আর ভাই, এডিট এ আমরা একটা কাজ করতে হবে, যদি কোনো পেইড জব হয়ে থাকে সেইটা ফ্রি করতে পারবে না, ক্লিয়ায় ভাই?


আর যদি কোনো ফ্রি জব হয়ে থাকে তাইলে সেটা এডিট পেইজ এ এসে পেইড সিলেক্ট করে , বাজেট এড করতে পারবে, ক্লিয়ার ভাই?




ভাই, জব ফ্রি হোক, অথবা পেইড , এতে ডেভেলপার এর কিছু আসে যাই নাই, ডেভেলপার কে বাজেট দিতেও পারে, আবার নাও দিতে পারে, দিলে
ডেভেলপার পেমেন্ট এ হিস্টোরি জমা হবে, নাইল নাই
...
ধরো বাজেট সব আপডেট করলো, তাইলে কি ভাই, ডেভেলপার পেমেন্ট অথবা পেমেন্ট এ গিয়ে কি আগের টা আপডেট হয়ে বসে যাবে? নাকি নতুন
হিস্টোরি জমা হবে?




এটা বলার কারন হচ্ছে প্রতিটা জব এড করার টাইম এ যদি টাকা দেই, তাইলে ত হিস্টোরি জমা হচ্ছে



এখন জব যদি এডিট করে তাইলে কি আবার নতুন করে হিস্টোরি হবে নাকি



আলোচনা করা এইটা কিভাবে মেইন্টেন করা হই? সিনিয়র রা বা, এইটার আদর্শ লজিক কি?


আমরা ভাই, আগে discussion করি, পরে কোড